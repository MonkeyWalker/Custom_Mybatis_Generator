...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        /*******use page info , 属性的别名**/
        ATTR_PAGE_INFO_ID,
        ATTR_PAGE_INFO_CURRENT_PAGE_ALIAS,
        ATTR_PAGE_INFO_SIZE_ALIAS,
    }
    ...
    public void setPageInfoID(String s) {
        internalAttributes.put(InternalAttribute.ATTR_PAGE_INFO_ID, s);
    }

    public void setPageInfoCurrentPageAlias(String s) {
        internalAttributes.put(InternalAttribute.ATTR_PAGE_INFO_CURRENT_PAGE_ALIAS, s);
    }

    public String getPageInfoCurrentPageAlias() {
        return internalAttributes.get(InternalAttribute.ATTR_PAGE_INFO_CURRENT_PAGE_ALIAS);
    }

    public void setPageInfoSizeAlias(String s) {
        internalAttributes.put(InternalAttribute.ATTR_PAGE_INFO_SIZE_ALIAS, s);
    }

    public String getPageInfoSizeAlias() {
        return internalAttributes.get(InternalAttribute.ATTR_PAGE_INFO_SIZE_ALIAS);
    }
    ...
    protected void calculateXmlAttributes() {
        ...
        setCountByExampleStatementId("countByConditions"); //$NON-NLS-1$
        setDeleteByExampleStatementId("deleteByConditions"); //$NON-NLS-1$
        setDeleteByPrimaryKeyStatementId("deleteByID"); //$NON-NLS-1$
        setInsertStatementId("insert"); //$NON-NLS-1$
        setInsertSelectiveStatementId("insertSelective"); //$NON-NLS-1$
        setSelectAllStatementId("selectAll"); //$NON-NLS-1$
        setSelectByExampleStatementId("selectByConditions"); //$NON-NLS-1$
        setSelectByExampleWithBLOBsStatementId("selectByConditionsWithBLOBs"); //$NON-NLS-1$
        setSelectByPrimaryKeyStatementId("selectByID"); //$NON-NLS-1$
        setUpdateByExampleStatementId("updateByConditions"); //$NON-NLS-1$
        setUpdateByExampleSelectiveStatementId("updateSelectiveFiledByConditions"); //$NON-NLS-1$
        ...
        setUpdateByPrimaryKeySelectiveStatementId("updateSelectiveFiledByID"); //$NON-NLS-1$
        setUpdateByPrimaryKeyWithBLOBsStatementId("updateByIDWithBLOBs"); //$NON-NLS-1$
        if (StringUtility.stringHasValue(this.getAliasedFullyQualifiedTableNameAtRuntime())) {
            setBaseResultMapId("resultMap_" + getAliasedFullyQualifiedTableNameAtRuntime());
        } else {
            setBaseResultMapId("resultMap");
        }
        setResultMapWithBLOBsId("ResultMapWithBLOBs"); //$NON-NLS-1$
        setExampleWhereClauseId("Where_conditions"); //$NON-NLS-1$
        //$NON-NLS-1$
        if (StringUtility.stringHasValue(this.getAliasedFullyQualifiedTableNameAtRuntime())) {
            setBaseColumnListId("AllFields_" + getAliasedFullyQualifiedTableNameAtRuntime());
        } else {
            setBaseColumnListId("allFields");
        }
        setBlobColumnListId("Blob_Column_List"); //$NON-NLS-1$
        setMyBatis3UpdateByExampleWhereClauseId("Update_Where_Clause"); //$NON-NLS-1$
        setPageInfoID("Page_info");
        setPageInfoCurrentPageAlias("currentPage");
        setPageInfoSizeAlias("size");
    }
    ...
    protected void calculateModelAttributes() {
        ...
        sb.append('.');
        sb.append(fullyQualifiedTable.getDomainObjectName());
        sb.append("Conditions"); //$NON-NLS-1$
    ...
    public String getPageInfoID() {
        return internalAttributes
                .get(InternalAttribute.ATTR_PAGE_INFO_ID);
    }
