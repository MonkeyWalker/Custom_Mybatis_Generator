...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    private void addPageInfoElement(XmlElement parentElement) {
        AbstractXmlElementGenerator elementGenerator = new PageInfoElementGenerator();
