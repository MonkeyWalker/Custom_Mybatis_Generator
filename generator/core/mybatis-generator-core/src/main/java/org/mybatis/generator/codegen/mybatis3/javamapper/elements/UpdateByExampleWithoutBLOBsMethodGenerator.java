...
public class UpdateByExampleWithoutBLOBsMethodGenerator extends
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        FullyQualifiedJavaType conditions = new FullyQualifiedJavaType(
                introspectedTable.getExampleType());
        method.addParameter(new Parameter(conditions,
                "conditions", "@Param(\"conditions\")")); //$NON-NLS-1$ //$NON-NLS-2$
        importedTypes.add(conditions);
