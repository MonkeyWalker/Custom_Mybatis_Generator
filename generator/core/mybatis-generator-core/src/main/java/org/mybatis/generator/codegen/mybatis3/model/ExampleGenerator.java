...
import org.mybatis.generator.codegen.mybatis3.model.helpers.ExampleGeneratorHelper;
...
public class ExampleGenerator extends AbstractJavaGenerator {
    ...
    public List<CompilationUnit> getCompilationUnits() {
        ...
        method.addBodyLine("pageConditionsStr = null;");
        method.addBodyLine("groupByClause = null;");
        commentGenerator.addGeneralMethodComment(method, introspectedTable);
        topLevelClass.addMethod(method);

        field = new Field();
        field.setName("pageConditionsStr");
        field.setVisibility(JavaVisibility.PROTECTED);
        field.setType(FullyQualifiedJavaType.getStringInstance());
        topLevelClass.addField(field);
        ...
        field.setType(FullyQualifiedJavaType.getStringInstance());
        topLevelClass.addField(field);
        ExampleGeneratorHelper.generatePageInfoStr(field, topLevelClass);
        ExampleGeneratorHelper.generateSetMethod(field,topLevelClass);
        ...
        topLevelClass.addInnerClass(getInnerFiledMapperClass());
    ...
    private InnerClass getInnerFiledMapperClass() {
        InnerClass answer = new InnerClass(new FullyQualifiedJavaType(
                "FiledNameMapper")); //$NON-NLS-1$
   ...
   /* */
    ...
    /**
     * @return page info class
     *//*
    private InnerClass getGeneratedPageInfoInnerClass(TopLevelClass topLevelClass){
        InnerClass answer = new InnerClass(FullyQualifiedJavaType
                .getGeneratedPageInfoInstance());
        answer.setVisibility(JavaVisibility.PROTECTED);
        answer.setStatic(true);

        Method singleParamConstruct = new Method();
        singleParamConstruct.setConstructor(true);
        singleParamConstruct.setName(FullyQualifiedJavaType
                .getGeneratedPageInfoInstance().getShortName());
        singleParamConstruct.addParameter(new Parameter(FullyQualifiedJavaType.getIntInstance(),"pageSize"));

        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("this.").append("pageSize").append(" = ").append("pageSize").append(";");
        singleParamConstruct.addBodyLine(stringBuilder.toString());
        answer.addMethod(singleParamConstruct);

        Method doubleParamCons = new Method();
        doubleParamCons.setConstructor(true);
        doubleParamCons.setName(FullyQualifiedJavaType
                .getGeneratedPageInfoInstance().getShortName());
        doubleParamCons.addParameter(new Parameter(FullyQualifiedJavaType.getIntInstance(),"currentPage"));
        doubleParamCons.addParameter(new Parameter(FullyQualifiedJavaType.getIntInstance(),"pageSize"));
        stringBuilder.setLength(0);
        stringBuilder.append("this.").append("currentPage").append(" = ").append("currentPage").append(";");
        stringBuilder.append("this.").append("pageSize").append(" = ").append("pageSize").append(";");
        doubleParamCons.addBodyLine(stringBuilder.toString());
        answer.addMethod(doubleParamCons);
